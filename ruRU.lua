...
L["Show corruption amount in the character screen"] = "Показать количество порчи на экране персонажа"
L["Show corruption stat on items in the character screen when displaying the corruption tooltip."] = "Показывать статистику порчи для предметов на экране персонажа при отображении всплывающей подсказки."
